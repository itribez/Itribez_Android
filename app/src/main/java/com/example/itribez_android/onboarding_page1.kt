...
//
//class onboarding_page1 : AppCompatActivity() {
//
...
//            val intent = Intent(this@onboarding_page1, LoginActivity::class.java)
...
//                    val intent = Intent(this@onboarding_page1, SplashActivity::class.java)
//                    startActivity(intent)
//                    finish()
//                    return true
//                } else {
//                    // Left swipe, navigate back to the SplashActivity
//                    val intent = Intent(this@onboarding_page1, onboarding_page2::class.java)
//                    startActivity(intent)
//                    finish()
//                    return true
//                }
